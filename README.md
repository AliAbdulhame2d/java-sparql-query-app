...
![MySQL Database](screenshots/Mysql_db.png)
...
![SPARQL Tables Query](screenshots/Take_RDF__file_tables.png)
...
![SPARQL Query Results](screenshots/Talkin_column_data.png)
